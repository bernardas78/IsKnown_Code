...
# model file
model_file_name = "A:\IsKnown_Results\\model_{}_Ind-{}.h5".format(date.today().strftime("%Y%m%d"), hier_lvl)

# learning curve file
lc_file_name = "A:\\IsKnown_Results\\lc_{}_Ind-{}.csv".format(date.today().strftime("%Y%m%d"), hier_lvl)

# data folder
data_folder = "C:\\IsKnown_Images\\Ind-{}".format (hier_lvl)
