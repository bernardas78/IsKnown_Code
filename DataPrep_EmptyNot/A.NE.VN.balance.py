...
src_folder = r"A:\IsKnown_Images\Aff_NE_VN_Hier"

#save_to_dir_template = r"A:\IsKnown_Images\Balanced"
save_to_dir_template = r"A:\IsKnown_Images\Aff_NE_VN_Balanced"
...
# Loop structure [Hier-x]\[TrainValTest]\classcode and balance
for hier_lvl in os.listdir(src_folder): # list Hier-x
    hier_lvl_full_folder = os.path.join(src_folder,hier_lvl)
    ...
    for set_lvl in os.listdir(hier_lvl_full_folder):    # list Train, Val, Test
        ...
        for classcode_lvl in os.listdir(set_lvl_folder):    # list class codes (barcode or shortened)
            ...
            dest_classcode_lvl_folder = os.path.join(save_to_dir_template,hier_lvl,set_lvl,classcode_lvl)
