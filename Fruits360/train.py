...
def trainModel(epochs=1, model_filename=None):
    ...
    callback_earlystop = EarlyStopping(monitor='val_accuracy', min_delta=0.0001, patience=10, verbose=1, mode='max', restore_best_weights=True )
...
#trainModel(epochs=200, model_filename=r"A:\IsKnown_Results\model_Fruits360_20210930.h5")
