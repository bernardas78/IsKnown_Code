...
data_folder = "A:\\IsKnown_Images\\Cropped"

dest_folder_visible = "A:\\IsKnown_Images\\Cleaned_AutoVisible\\v{}\\"
dest_folder_invisible = "A:\\IsKnown_Images\\Cleaned_AutoInvisible\\v{}\\"
...
for version in versions:
    ...
    for img_file in img_file_lst:
        ...
        dest_folder_barcode = os.path.join(dest_folder.format(version), barcode)
