...
plt.title ("Image counts in classes (All)", fontsize=16, fontweight='bold')
plt.xlabel("Image count in class", fontsize=14, fontweight='bold')
plt.ylabel("Number of classes", fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig("hist_prekiuFreq.png")
plt.show()
plt.close()
...
plt.tick_params(axis='both', which='major', labelsize=14)
plt.title ("Image counts in classes (<100 images/class)", fontdict={'fontsize':16, 'fontweight': 'bold'} )
plt.xlabel("Image count in class", fontsize=14, fontweight='bold')
plt.ylabel("Number of classes", fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig("hist_prekiuFreq_less100.png")
plt.show()
plt.close()