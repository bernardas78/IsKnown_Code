...
data_folder =  os.path.join( Glb.images_folder, "Affine_s3")
...
for img_file in img_file_lst:
    ...
    dest_folder_emptyornot= dest_folder_notempty if is_notempty else dest_folder_empty
    dest_folder_barcode = os.path.join(dest_folder_emptyornot, barcode)
