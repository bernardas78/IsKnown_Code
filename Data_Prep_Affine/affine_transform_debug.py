# (Debug - split by SCO) Affine transformations of all files in a folder
...
dst_folder = r"A:\IsKnown_Images\Affine_Dbg"
...
for sco_lvl in os.listdir(src_folder):
    ...
    for barcode_lvl in os.listdir(sco_lvl_full_folder):
        ...
        dest_barcode_folder = os.path.join(dst_folder, sco_lvl) #, barcode_lvl
